...
db.movies.find({$or: [{category: "sci-fi"}, {ratings: {$elemMatch: {$gt: 199}}}]}, {_id: 0, title: 1, ratings: 1, category: 1});
...
db.movies.find({ratings: {$size: 4}, category: {$all: ["adventure", "family"]}, imdbRating: {$gte: 7}});
