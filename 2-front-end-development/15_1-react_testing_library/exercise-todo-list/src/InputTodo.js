...
class InputTodo extends Component {
  ...
  render() {
    const { addTodo, buttonAvailability, removeToDo } = this.props;
    ...
    return (
      <div className="InputTodo">
        ...
        <input data-testid="id-remove" type="button" value="Remover" disabled={buttonAvailability} onClick={removeToDo} />
      </div>
    );
  }
}
